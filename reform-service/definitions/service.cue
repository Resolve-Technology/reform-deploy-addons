...
template: {
  ...
  outputs: {
	...
	// // define Secret resource
	// outputs: {
	// 	if parameter.secrets != _|_ {
	// 		vaultsecret: {
	...
	// 				mount: "kvv2"
	// 				type: "kv-v2"
	// 				path: "applications/" + context.name
	// 				hmacSecretData: true
	// 				refreshAfter: "60s"
	// 				destination: {
  //           annotations: {
  //             "application.deploy.reform/name": context.name
  //           }
	// 					labels: {
	// 						"secret.application.deploy.reform/identifier": context.name
	// 					}
	// 					create: true
	// 					name: context.name
	// 					type: "Opaque"
	...
	parameter: {
		...
		// secrets?: [...{
		// 	// +usage=The name of the secret as environment variable
		// 	name: string
